  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center">
      <div className="bg-black w-[80%] max-w-md p-6 text-center shadow-lg">
        <h2 className="text-red-500 text-3xl font-pixelvt mb-6">Enter Player Names</h2>

        <input
          className="w-full mb-4 p-3 text-red-500 font-pixelvt text-xl border border-gray-300 bg-white outline-none"
          type="text"
        ...
        <input
          className="w-full mb-6 p-3 text-red-500 font-pixelvt text-xl border border-gray-300 bg-white outline-none"
          type="text"
        ...
        <button
          ...
          className="bg-blue-600 text-white font-pixelvt text-3xl w-full py-3 hover:bg-blue-700"
        >
          Start Game
        </button>
      </div>
